...
const required = [
  ...
  "pyproject.toml",
  "evaluations/assurance-workflow-v1.json",
  "LICENSE",
];
...
const expectations = [
  ...
  [html.includes('id="cases"'), "The case library is required"],
  [html.includes('id="business-case"'), "The buyer business-case calculator is required"],
  [html.includes("cannot approve production use"), "The production-approval boundary must be visible"],
  [html.includes("unvalidated"), "The static-rule indicator must be visibly unvalidated"],
  [app.includes("skippedFiles"), "Skipped file evidence must remain in the report journey"],
  [app.includes("resolved_finding_ids"), "Reassessment evidence must remain in the export"],
